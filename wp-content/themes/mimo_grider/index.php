...
<head>
	...
	<?php endif; 
	$favicon = str_replace("&quot;", '"', str_replace("'", '"', $gantry->get('favicon')));
		$dato = json_decode($favicon);?>
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo $dato->path; ?>" />
...
<body <?php echo $gantry->displayBodyTag(); ?>>
	...
	<div id="rt-transition"<?php if ($gantry->get('loadtransition')) echo $hidden; ?>>
		<div id="rt-mainbody-surround">
			...
			<?php /** Begin Main Body **/ ?>
			<div class="rt-container">
				<?php echo $gantry->displayMainbody('mainbody','sidebar','standard','standard','standard','standard','standard'); ?> <?php register_sidebar(); ?><?php dynamic_sidebar(); ?>
			</div>
			<?php /** End Main Body **/ ?>
