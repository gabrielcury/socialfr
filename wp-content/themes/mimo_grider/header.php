...
?>
<!doctype html>
<html <?php language_attributes(); ?> xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $gantry->language; ?>" lang="<?php echo $gantry->language;?>" >
<head>
...
<body <?php echo $gantry->displayBodyTag(); ?> <?php body_class($class); ?>>
