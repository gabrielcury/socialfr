var mimocarousel = function($) {
	var thiswidth= $('#ca-container').outerWidth(true);
	var	aux		= {
			...
			init 		: function( options ) {
				...
				if( this.length ) {
					...
					return this.each(function() {
						...
						// adds events to the mouse commented give problems duplicated items 
