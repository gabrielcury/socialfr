...
{
	$msg =  $msg = _e('The active theme requires the Gantry Framework Plugin to be installed and active','grider');
...
{
	echo 'T HEME  SH ARED  ON  WPL OCK ER.COM - This theme requires the Gantry Framework Plugin to be installed and active.';
	die(0);
}
...
require_once('includes/custom_scripts.php');
require_once('includes/custom_functions.php');
require_once('includes/custom_shortcodes.php');
include_once 'includes/metaboxes/setup.php';
include_once 'includes/metaboxes/simple-spec.php';
include_once 'includes/metaboxes/youtube-spec.php';
include_once 'includes/metaboxes/checkbox-spec.php';
include_once 'includes/metaboxes/vimeo-spec.php';
include_once 'includes/metaboxes/review-spec.php';
include ('includes/twitteroauth.php');
//include_once 'includes/metaboxes/select-spec.php';
