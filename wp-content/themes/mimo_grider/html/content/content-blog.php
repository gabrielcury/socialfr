...
<div class="article-title">
				...
				<?php if( $gantry->get( 'blog-meta-author-enabled', '1' ) || $gantry->get( 'blog-meta-category-enabled', '0' ) || $gantry->get( 'blog-meta-category-parent-enabled', '0' ) || $gantry->get( 'blog-meta-date-enabled', '1' ) || $gantry->get( 'blog-meta-modified-enabled', '0' ) || $gantry->get( 'blog-meta-comments-enabled', '1' ) ) : ?>
					...
					<dl class="article-info">
						...
						<?php if( $gantry->get( 'blog-meta-category-parent-enabled', '0' ) && !empty( $category ) && $category[0]->parent != '0' ) : ?>
						...
						<?php if( $gantry->get( 'blog-meta-category-enabled', '0' ) && !empty( $category ) ) : ?>
						...
						<?php if( $gantry->get( 'blog-meta-modified-enabled', '1' ) ) : ?>
						...
						<?php if( $gantry->get(  'blog-meta-rating-enabled', '1' ) ) : 
					...
					if($metareview): 
							...
							<?php if( $gantry->get(  'blog-meta-rating-link', '0' ) ) : ?>
				...
				<?php if( has_tag() && $gantry->get( 'blog-meta-tags-enabled', '1' ) ) : ?>
				...
				<?php /** End Tags **/ ?>
				<?php if( $gantry->get( 'blog-readmore-show', 'auto' ) == 'always' || ( $gantry->get( 'blog-readmore-show', 'auto' ) == 'auto' && ( preg_match( '/<!--more(.*?)?-->/', $post->post_content ) || $gantry->get( 'blog-content', 'content' ) == 'excerpt' ) ) ) : ?>
